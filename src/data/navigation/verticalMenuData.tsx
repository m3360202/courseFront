...
const verticalMenuData = (dictionary: Awaited<ReturnType<typeof getDictionary>>): VerticalMenuDataType[] => [
  ...
  {
    label: dictionary['menu'].dashboards,
    ...
    children: [
      ...
      {
        label: dictionary['menu'].course,
        href: '/dashboards/crm'
      },
      {
        label: dictionary['menu'].calendar,
        href: '/dashboards/analytics'
      },
      {
        label: dictionary['menu'].message,
        href: '/dashboards/ecommerce'
      },
      {
        label: dictionary['menu'].search,
        href: '/dashboards/academy'
      }
    ]
  },
  {
    label: dictionary['menu'].organization,
    ...
    children: [
      ...
      {
        label: dictionary['menu'].user,
        href: '/front-pages/checkout',
        target: '_blank',
        excludeLang: true
      },
      {
        label: dictionary['menu'].document,
      ...
      {
        label: dictionary['menu'].payment,
        href: '/front-pages/help-center',
        target: '_blank',
        excludeLang: true
      },
      {
        label: dictionary['menu'].supervision,
        href: '/front-pages/help-center',
        target: '_blank',
        excludeLang: true
      }
