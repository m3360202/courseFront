...
const OptionMenu = (props: OptionsMenuType) => {
  ...
  const menuItem = (option: OptionMenuItemType, index: number) => (
    <MenuItem
      key={index}
              ...
              <ClickAwayListener onClickAway={handleClose}>
                <MenuList autoFocusItem={open}>
                  {options.map((option: OptionType, index: number) => {
                    const confirm = (option as OptionMenuItemType)?.confirm
                    const confirmText = (option as OptionMenuItemType)?.confirmText
